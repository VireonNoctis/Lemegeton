...
class NewsCog(commands.Cog):
    def __init__(self, bot):
        ...
        if _SNSCRAPE_AVAILABLE:
            ...
            logging.warning("snscrape not available; NewsCog background task disabled. Install 'snscrape' to enable Twitter scraping.")
    ...
    async def fetch_new_tweets(self, handle, last_id):
        ...
        try:
            ...
            logging.error(f"Error fetching tweets from {handle}: {e}")
            return []
