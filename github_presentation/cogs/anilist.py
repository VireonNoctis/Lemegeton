# anilist.py
# Full updated cog — features:
# - Activity/message/list handling (existing)
# - Robust persistent paginators for activities
# - Media (anime/manga) embeds with banner, cover, synopsis, titles, stats, studios, source, popularity, favourites
# - Media paginator + "More details" dropdown with Relations / Characters / Support Cast / Staff / Stats Distribution / Recommendations / Tags
# - Persistent views across restarts (message_id tied)
# - Safety and graceful error handling throughout
#
# Drop-in replacement for your existing cog. Adjust STATE_FILE path or logging as needed.
